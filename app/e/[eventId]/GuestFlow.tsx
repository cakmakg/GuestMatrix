...
export default function GuestFlow({ eventId, eventName, brandName, description }: Props) {
        ...
        <div className="p-6">
          ...
          {step === 'landing' && (
            <div className="space-y-4">
              ...
              <p className="text-gray-700">Teile deine Fotos und Videos mit allen Gästen!</p>
              ...
              <div className="border rounded-xl p-4 bg-gray-50 space-y-3">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-600">
                    Ich stimme zu, dass meine Fotos/Videos gespeichert und für alle Gäste dieses
                    Events sichtbar gemacht werden. Ich kann meine Einwilligung jederzeit widerrufen
          ...
          {step === 'upload' && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-400">JPEG, PNG, MP4 oder MOV · Max. 100 MB</p>
          ...
          {step === 'success' && (
            <div className="space-y-4 text-center">
              ...
              <p className="text-gray-800 font-semibold text-lg">Danke für deinen Beitrag!</p>
          ...
          {step === 'rating' && (
            <div className="space-y-4 text-center">
              <p className="text-gray-700 font-medium">Wie war das Event für dich?</p>
